    ...
    const securityFeatures = [
        {
            ...
            description:
                'Your data is encrypted in transit using TLS 1.2+ and at rest using AES-256 encryption standards.',
            icon: Lock,
        },
        {
            title: 'Access Control',
            description:
                'Granular role-based access control (RBAC) ensures users only see what they need to see.',
            icon: Key,
        },
        {
            title: 'Compliance',
            description:
                'We adhere to SOC 2 Type II, GDPR, and CCPA standards to ensure your data is handled responsibly.',
            icon: FileCheck,
        },
        {
            title: 'Infrastructure',
            description:
                'Hosted on secure AWS cloud infrastructure with 99.9% uptime guarantee and automated backups.',
            icon: Server,
        },
        {
            title: 'Monitoring',
            description:
                '24/7 automated threat detection and real-time monitoring of all system activities.',
            icon: Eye,
        },
        {
            title: 'Authentication',
            description:
                'Support for Multi-Factor Authentication (MFA) and Single Sign-On (SSO) via SAML/OIDC.',
            icon: UserCheck,
        },
    ];
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
                ...
                <section className="px-4 py-20 sm:px-6 lg:px-8">
                    <div className="animate-on-scroll mx-auto max-w-3xl text-center">
                        ...
                        <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                            ...
                            We protect your data with the same level of security
                ...
                {/* Compliance Badges */}
                <section className="animate-on-scroll border-y border-slate-200 bg-white px-4 py-16 dark:border-slate-700 dark:bg-slate-900">
                    <div className="mx-auto max-w-7xl text-center">
                        <p className="mb-8 text-sm font-semibold tracking-wider text-slate-500 uppercase dark:text-slate-400">
                ...
                <section className="px-4 py-24 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-7xl space-y-24">
                        {/* Section 1 */}
                        <div className="animate-on-scroll grid items-center gap-12 lg:grid-cols-2">
                            <div>
                                <h2 className="text-3xl font-bold text-slate-900 dark:text-white">
                                    Secure by Design
                                </h2>
                                <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                                    Our security architecture is built on the
                                    principle of defense in depth. Multiple
                                    layers of security controls protect your
                                    data at every level of our infrastructure.
                                </p>
